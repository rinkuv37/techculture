    ...
    return (
        <section className='py-20'>
            <div className='container relative'>
                ...
                <h2 className='text-[40px] font-bold text-gray-700 leading-[60px] text-center mt-2'>Real Stories from  <span className='text-gred'>Happy Customers</span></h2>

                <p className="text-gray-700 text-[20px] text-center">Discover how our solutions have transformed businesses across various industries</p>
                    ...
                    >
                        <SwiperSlide>
                            <div className='testimonialItem bg-orange-50 w-full rounded-md p-10'>
                                <p className=' underline text-gray-700 text-[21px] italic text-center leading-10 pb-6'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum.</p>
                                ...
                                <div className='flex items-center justify-between gap-5 mt-5'>
                                    <div className='flex items-center gap-5'>
                                        ...
                                        <div className='info flex flex-col'>
                                            <h4 className='font-bold text-[20px] text-gray-800'>MATTIE WARNER</h4>
