                ...
                <SwiperSlide>
                    <div className="item bg-[url('/slide1.jpg')] h-screen w-full bg-cover bg-center relative">
                        ...
                        <div className='info absolute top-[25%] left-[5.6%] w-[70%] h-screen flex flex-col z-[60] gap-4'>
                            ...
                            <h2 className='text-white text-[60px] font-extralight leading-[80px]'>Scalable & resilient infrastructure with Cloud Solutions</h2>
                ...
                <SwiperSlide>
                    <div className="item bg-[url('/slide2.jpg')] h-screen w-full bg-cover bg-center relative">
                        ...
                        <div className='info absolute top-[25%] left-[5.6%] w-[70%] h-screen flex flex-col z-[60] gap-4'>
                            ...
                            <h2 className='text-white text-[60px] font-extralight leading-[80px]'>Protecting your assets with Cybersecurity & Compliance</h2>
